				...
				<div className="container-fluid">
			    	<div className="navbar-header">
				   	...
				   	<ul className="nav navbar-nav">
			     		...
			     		<li><ReactRouter.Link activeClassName="active" to="/two">Two</ReactRouter.Link></li>
			      		<li><ReactRouter.Link activeClassName="active" to="/three">Three</ReactRouter.Link></li>
			      		<li><ReactRouter.Link activeClassName="active" to="/four">Four</ReactRouter.Link></li>
				    </ul>
				</div>
			</nav>    
		)
